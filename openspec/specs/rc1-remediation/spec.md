...
## Purpose
Define RC1 hardening requirements for structured command execution, component-normalized workspace paths, Git sandboxing, true Wasmtime component loading, and repository security hygiene.
## Requirements
