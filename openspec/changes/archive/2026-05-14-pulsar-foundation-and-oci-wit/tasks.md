...
- [x] Add cargo-component-compatible `[package.metadata.component.dependencies]` blocks to all FaaS agents and map them to the `ghcr.io/astorise/tachyon-mesh-wit:0.9.0-rc.1` OCI registry.
