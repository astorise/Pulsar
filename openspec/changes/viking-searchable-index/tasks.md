...
- [ ] **Task 2: Implement Search Logic in Viking**
...
- [ ] **Task 3: Proactive Crawler with Smart Filtering (Orchestrator)**
...
- [ ] **Task 4: Add Search Tool to the Orchestrator**
...
- [ ] **Task 5: Refine the Meta-Prompt (Connect -> Ask -> Act)**
