...
- [ ] **Task 2: Scaffold `faas/cognitive-gc`**
...
- [ ] **Task 3: Implement Clustering Logic**
...
- [ ] **Task 4: Implement The Judge Prompt**
...
- [ ] **Task 5: Execute Memory Compaction**
